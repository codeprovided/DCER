...
u_text = pad_sentences(u_text, 346)  # Standardize the number of words in user comments.
print("pad user done")
# i_text = pad_sentences(i_text, 346)  # Standardize the number of words in item comments.
# print("pad item done")
#
...
# u_text, i_text = build_input_data_1(u_text, i_text, vocabulary_user, vocabulary_item)  # Convert the words in the comments to numbers.
