...
class MTGE(nn.Module):
    ...
    def forward(self, nodes_u, nodes_v, history_u_lists, history_ura_lists, history_v_lists, history_vra_lists):  # 输入信息
...
def main():
    ...
    print("load model......")
    mtge_best.load_state_dict(torch.load('../model/ge_ele.pt'))
    expected_rmse, mae = test(mtge_best, device, test_loader, history_u_lists, history_ura_lists,
                                  history_v_lists, history_vra_lists)
    ...
    for epoch in range(1, opts.epochs + 1):
        ...
        train(mtge, device, train_loader, optimizer, epoch, best_rmse, best_mae, history_u_lists, history_ura_lists,
              history_v_lists, history_vra_lists)
        expected_rmse, mae = test(mtge, device, test_loader, history_u_lists, history_ura_lists,
                                  history_v_lists, history_vra_lists)
